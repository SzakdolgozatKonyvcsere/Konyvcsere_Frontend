    ...
    <>
      {userBookOffersInfo
        ...
        <div key={index} className="card all-available-books" style={{ width: "18rem" }}>
          <img className='all-available-books__image' style={{objectFit: "contain"}} src={bookDetail?.img_url ? `http://localhost:8000/${bookDetail?.img_url}` : '/basic_bookDetail.png'}></img>
