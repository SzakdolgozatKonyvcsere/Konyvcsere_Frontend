...
export default function UserOwnExchangesCard2(props) {
  ...
  const handleClickBook = () => {
    ...
    return(
        ...
        {props.exchange.exchange_status === "f" && offeredBook && !isInterestedUser
            ? "Csere partnered válaszára vársz"
            : isInterestedUser && !offeredBook
            ? "Kérelmed elküldve, várakozás"
            : "Csere elfogadására vársz - te jössz"}        
        </div>
        <div className="card-body">
            ...
            {props.exchange.exchange_status === "f" && !isInterestedUser && offeredBook && (
