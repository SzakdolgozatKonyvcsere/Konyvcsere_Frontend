...
export default function ExchangeTableAdmin({ exchanges }) {
  ...
  const szuksegesExchanges = exchanges.map(exchange => ({
    ...
    desired_book_id: exchange.desired_book_id,
  ...
  return (
    <TableAdminCreate
      tHeadLabels={{
        exchange_id: "ID",
        desired_book_id: "Kért könyv ID",
        desired_book_title: "(K) Könyv címe",
        desired_owner_name: "(K) Könyv tulajdonosa",
        desired_owner_email: "(K) Tulajdonos emailje",
        desired_owner_city: "(K) Tulajdonos városa",
        desired_owner_tel: "(K) Tulajdonos tel.",
        offered_book_id: "Felajánlott könyv ID",
        offered_book_title: "(F) Könyv címe",
        offered_owner_name: "(F) Könyv tulajdonosa",
